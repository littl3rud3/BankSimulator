...
//
//import static com.example.exchangeapp.config.MongockConfig.PERSONAL_INFO_COLLECTION_NAME;
...
//
///**
// * Ченжлог для создания и заполнения коллекции личных данных.
// */
//@ChangeUnit(id = "personalInfoCollection", order = "2", author = "littl3rud3")
//@RequiredArgsConstructor
//public class PersonalInfoChangeLog {
//
...
//        mongoDatabase.createCollection(PERSONAL_INFO_COLLECTION_NAME).subscribe(subscriber);
//        subscriber.await();
//    }
//
//    /**
...
//        SubscriberSync<Void> subscriber = new MongoSubscriberSync<>();
//        mongoDatabase.getCollection(PERSONAL_INFO_COLLECTION_NAME).drop().subscribe(subscriber);
//        subscriber.await();
//    }
//
//    /**
...
//        mongoDatabase.getCollection(PERSONAL_INFO_COLLECTION_NAME, PersonalInfo.class)
//                     .insertMany(clientSession, easyRandom.objects(PersonalInfo.class, insertCount).toList())
...
//
//        mongoDatabase
//            .getCollection(PERSONAL_INFO_COLLECTION_NAME, PersonalInfo.class)
